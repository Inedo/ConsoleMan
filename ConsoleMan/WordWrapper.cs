...
/// <summary>
/// Contains methods for writing wrapped text to the console.
/// </summary>
public static class WordWrapper
{
    /// <summary>
    /// Writes wrapped text to the console stdout stream.
    /// </summary>
    /// <param name="text">Text to write.</param>
    /// <param name="margin">Left side margin in spaces.</param>
    ...
    /// <summary>
    /// Writes wrapped text to the console stderr stream.
    /// </summary>
    /// <param name="text">Text to write.</param>
    /// <param name="margin">Left side margin in spaces.</param>
